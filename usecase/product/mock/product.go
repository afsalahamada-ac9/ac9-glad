...
func (m *MockReader) GetByExtID(tenantID id.ID, extID string) (*entity.Product, error) {
	m.ctrl.T.Helper()
...
// GetByExtID mocks base method.
func (m *MockRepository) GetByExtID(tenantID id.ID, extID string) (*entity.Product, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByExtID", tenantID, extID)
	ret0, _ := ret[0].(*entity.Product)
	ret1, _ := ret[1].(error)
